...
var colors = { "": "white", "2":"#eee4da", "4":"#ece0c8", "8":"#f2b179", "16":"#f59563", "32":"#f57c5f", "64":"#f95c3b",
                "128":"#edce71", "256":"#eecc61", "512":"#ebc850", "1024":"#edc53f" , "2048":"#eec22e", "4096":"#3399FF", "8192":"#3d3a33", "16384":"#C70606" }
...
function init(col, row, parent)
{
    ...
    rows = row;
    baseObj = parent;
    //cellWidth = baseObj.board.width / columns;
    //cellHeight = baseObj.board.height / rows; 
...
function create(row, col, value, respaun)
{
    ...
    object.x = cellWidth * col;
    object.y = cellHeight * row;


    //console.log("WIDTH: "+object.width+" HEIGHT:"+object.height)
...
//    if (!arrCells) return;
    ...
    for (var i = 0; i < rows; ++i) {
        for (var j = 0; j < columns; ++j) {
            if( arrCells[i][j]!==0 && arrCells !== undefined){
                var object = arrCells[i][j];
